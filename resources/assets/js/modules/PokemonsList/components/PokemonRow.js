...
export default props =>
  <div className="Pokemon-row">
    ...
    />
    <div className="Pokemon-row__content">
      <div className="Pokemon-row__title">
        <div className="Pokemon-row__name">
          {props.name}
        </div>
        <div className="Pokemon-row__main-attributes">
      ...
      <div className="Pokemon-row__other-attributes">
